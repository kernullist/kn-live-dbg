...
#define KNDBG_TIMELINE_MIN_CAPACITY 128u
#define KNDBG_TIMELINE_MAX_CAPACITY 16384u
#define KNDBG_TIMELINE_IMAGE_PATH_CHARS 260u
...
#define KNDBG_TIMELINE_CONTROL_CLEAR 3u

#define KNDBG_TIMELINE_STATUS_ACTIVE 0x00000001u
#define KNDBG_TIMELINE_STATUS_PROCESS_CALLBACK 0x00000002u
#define KNDBG_TIMELINE_STATUS_IMAGE_CALLBACK 0x00000004u
#define KNDBG_TIMELINE_STATUS_THREAD_CALLBACK 0x00000008u

#define KNDBG_TIMELINE_EVENT_PROCESS_CREATE 1u
#define KNDBG_TIMELINE_EVENT_PROCESS_EXIT 2u
#define KNDBG_TIMELINE_EVENT_IMAGE_LOAD 3u
#define KNDBG_TIMELINE_EVENT_THREAD_CREATE 4u
#define KNDBG_TIMELINE_EVENT_THREAD_EXIT 5u
...
typedef struct _KNDBG_TIMELINE_CONTROL_REQUEST
{
    KNDBG_UINT32 Size;
    KNDBG_UINT32 Action;
    KNDBG_UINT32 Flags;
    KNDBG_UINT32 Capacity;
    KNDBG_UINT64 Acknowledge;
} KNDBG_TIMELINE_CONTROL_REQUEST;

typedef struct _KNDBG_TIMELINE_STATUS_RESPONSE
{
    KNDBG_UINT32 Size;
    KNDBG_UINT32 Flags;
    KNDBG_UINT32 Capacity;
    KNDBG_UINT32 Count;
    KNDBG_UINT64 Dropped;
    KNDBG_UINT64 NextSequence;
} KNDBG_TIMELINE_STATUS_RESPONSE;

typedef struct _KNDBG_TIMELINE_EVENT_RECORD
{
    KNDBG_UINT32 Size;
    KNDBG_UINT32 Type;
    KNDBG_UINT32 Flags;
    ...
    KNDBG_UINT64 ImageBase;
    KNDBG_UINT64 ImageSize;
    KNDBG_UINT64 FileObject;
    wchar_t ImagePath[KNDBG_TIMELINE_IMAGE_PATH_CHARS];
} KNDBG_TIMELINE_EVENT_RECORD;

typedef struct _KNDBG_TIMELINE_DRAIN_REQUEST
{
    KNDBG_UINT32 Size;
    KNDBG_UINT32 MaxEvents;
} KNDBG_TIMELINE_DRAIN_REQUEST;

typedef struct _KNDBG_TIMELINE_DRAIN_RESPONSE
{
    KNDBG_UINT32 Size;
    KNDBG_UINT32 Count;
    KNDBG_UINT32 Remaining;
    KNDBG_UINT32 Reserved;
    KNDBG_UINT64 Dropped;
    KNDBG_UINT64 NextSequence;
    KNDBG_TIMELINE_EVENT_RECORD Events[1];
} KNDBG_TIMELINE_DRAIN_RESPONSE;
