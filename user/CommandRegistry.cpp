...
const std::vector<CommandInfo>& CommandRegistry::Commands()
{
    static const std::vector<CommandInfo> commands =
    {
        ...
        Make(L"dD", L"dq", L"memory", L"display double-width values through qword view", CommandSupport::Alias),
        ...
        Make(L"!byovd", L"!byovd", L"kernel", L"scan loaded kernel modules against BYOVD hash/YARA intelligence and Authenticode/WDAC posture", CommandSupport::Native),
        ...
        Make(L"!token", L"!token", L"kernel", L"inspect process token privileges plus TokenType/SessionId/integrity-level object fields", CommandSupport::Native),
        ...
        Make(L"!inputstack", L"!inputstack", L"kernel", L"walk keyboard/mouse class device stacks and flag unknown attached drivers", CommandSupport::Native),
        Make(L"!dma", L"!dma", L"kernel", L"report IOMMU firmware tables, Kernel DMA Protection, and removable PCI bus posture", CommandSupport::Native),
        Make(L"!hv", L"!hv", L"kernel", L"report hypervisor presence from CPUID, CR4.VMXE, and CPUID timing without FEATURE_CONTROL", CommandSupport::Native),
        Make(L"dump-analyze", L"dump-analyze", L"memory", L"parse a dump-kernel DUMP_HEADER64, physical runs, and loaded modules (4-level or LA57 5-level VA walk)", CommandSupport::Native),
        ...
        Make(L"!kpage", L"!kpage", L"kernel", L"find executable kernel pages outside loaded modules; /deep adds a PFN-database pass", CommandSupport::Native),
        ...
        Make(L"eD", L"eq", L"memory", L"enter double-width values through qword write", CommandSupport::Alias),
        ...
        Make(L"l-", L"l-", L"source", kRequiresDbgEng, CommandSupport::DbgEng),
        Make(L"ld", L".reload", L"symbols", L"reload kernel module symbols", CommandSupport::Alias),
