...
const std::vector<CommandInfo>& CommandRegistry::Commands()
{
    static const std::vector<CommandInfo> commands =
    {
        ...
        Make(L"dt", L"dt", L"type", L"display type fields", CommandSupport::Native),
        Make(L"dtx", L"dtx", L"type", L"display type fields through native type reader", CommandSupport::Alias),
        Make(L"callbacks", L"callbacks", L"kernel", L"list object, registry, process, and minifilter callbacks", CommandSupport::Native),
        Make(L"kcallbacks", L"callbacks", L"kernel", L"list kernel callbacks", CommandSupport::Alias),
        Make(L"cb", L"callbacks", L"kernel", L"list kernel callbacks", CommandSupport::Alias),
        ...
        Make(L"u", L"u", L"code", kRequiresDbgEng, CommandSupport::DbgEng),
        Make(L"uf", L"uf", L"code", kRequiresDbgEng, CommandSupport::DbgEng),
