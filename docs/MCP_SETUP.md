...
mcp_servers:
  knlivedbg:
    ...
    connect_timeout: 60
    # tools:            # optional: expose only what you need (45 read tools is a lot of context)
...
### 6.1 Read tools (45, no `--allow-write` needed — except `ti.subscribe` start/stop)
