...
mcp_servers:
  knlivedbg:
    ...
    connect_timeout: 60
    # tools:            # 선택: 필요한 것만 노출(read 툴 45개는 컨텍스트를 많이 먹음)
...
### 6.1 읽기 툴 (45종, `--allow-write` 불필요 — 단 `ti.subscribe` start/stop 제외)
